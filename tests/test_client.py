...
@unittest.mock.patch("httpx2.Client")
...
def test_get_namespaced(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
...
def test_get_global(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    httpx2_mock.get("https://localhost:9443/api/v1/nodes/n1").respond(json={"metadata": {"name": "n1"}})
...
def test_list_namespaced(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
...
def test_list_crd(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
...
def test_list_global(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
...
def test_list_chunk_size(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
...
def test_delete_namespaced(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    httpx2_mock.delete("https://localhost:9443/api/v1/namespaces/default/pods/xx")
    client.delete(Pod, name="xx")

    httpx2_mock.delete("https://localhost:9443/api/v1/namespaces/other/pods/xx")
    client.delete(Pod, name="xx", namespace="other")

    # test grace_period parameter
    httpx2_mock.delete("https://localhost:9443/api/v1/namespaces/default/pods/x_grace?gracePeriodSeconds=30")
    client.delete(Pod, name="x_grace", grace_period=30)

    # test cascade parameter
    httpx2_mock.delete("https://localhost:9443/api/v1/namespaces/default/pods/x_cascade?propagationPolicy=Background")
    client.delete(Pod, name="x_cascade", cascade=types.CascadeType.BACKGROUND)

    # test dry_run parameter
    req_dry = httpx2_mock.delete("https://localhost:9443/api/v1/namespaces/other/pods/z?dryRun=All")
    client.delete(Pod, name="z", namespace="other", dry_run=True)
    assert req_dry.calls[0][0].url.params["dryRun"] == "All"


def test_delete_global(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    httpx2_mock.delete("https://localhost:9443/api/v1/nodes/xx")
    client.delete(Node, name="xx")

    # test dry_run parameter
    req_dry = httpx2_mock.delete("https://localhost:9443/api/v1/nodes/z?dryRun=All")
    client.delete(Node, name="z", dry_run=True)
    assert req_dry.calls[0][0].url.params["dryRun"] == "All"


def test_delete_collection_namespaced(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    # test dry_run parameter
    ...
    httpx2_mock.delete("https://localhost:9443/api/v1/namespaces/default/pods")
    client.deletecollection(Pod)

    httpx2_mock.delete("https://localhost:9443/api/v1/namespaces/other/pods")
    client.deletecollection(Pod, namespace="other")

    # test grace_period parameter
    httpx2_mock.delete("https://localhost:9443/api/v1/namespaces/grace/pods?gracePeriodSeconds=30")
    client.deletecollection(Pod, namespace="grace", grace_period=30)

    # test cascade parameter
    httpx2_mock.delete("https://localhost:9443/api/v1/namespaces/cascade/pods?propagationPolicy=Orphan")
    client.deletecollection(Pod, namespace="cascade", cascade=types.CascadeType.ORPHAN)


def test_deletecollection_global(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    # test dry_run parameter
    req_dry = httpx2_mock.delete("https://localhost:9443/api/v1/nodes?dryRun=All")
...
def test_errors(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    httpx2_mock.get("https://localhost:9443/api/v1/namespaces/default/pods/xx").respond(content="Error", status_code=409)
    httpx2_mock.get("https://localhost:9443/api/v1/namespaces/default/pods/xx").respond(
...
def test_watch(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
...
def test_watch_error(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
...
def test_watch_on_error(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    httpx2_mock.get("https://localhost:9443/api/v1/nodes?watch=true&resourceVersion=1").respond(status_code=404)
    httpx2_mock.get("https://localhost:9443/api/v1/nodes?watch=true").respond(content=make_watch_list())
...
def test_watch_stop_iter(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    httpx2_mock.get("https://localhost:9443/api/v1/nodes?watch=true").respond(content=make_watch_list())

    it = client.watch(Node, on_error=types.on_error_raise)
    next(it)
...
def test_wait_success(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
...
def test_wait_deleted(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    base_url = "https://localhost:9443/api/v1/nodes?fieldSelector=metadata.name%3Dtest-node&watch=true"
...
def test_wait_failed(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    base_url = "https://localhost:9443/api/v1/nodes?fieldSelector=metadata.name%3Dtest-node&watch=true"
...
def test_wait_custom(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
...
def test_patch_namespaced(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    # Default PatchType.STRATEGIC
    req = httpx2_mock.patch("https://localhost:9443/api/v1/namespaces/default/pods/xx").respond(
    ...
    # PatchType.MERGE
    req = httpx2_mock.patch("https://localhost:9443/api/v1/namespaces/other/pods/xx").respond(
        json={"metadata": {"name": "xx"}}
    )
    pod = client.patch(
        Pod,
    ...
    # PatchType.APPLY
    req = httpx2_mock.patch("https://localhost:9443/api/v1/namespaces/other/pods/xy?fieldManager=test").respond(
    ...
    req = httpx2_mock.patch("https://localhost:9443/api/v1/namespaces/other/pods/xz?fieldManager=test&force=true").respond(
    ...
    with pytest.raises(ValueError, match="field_manager"):
        client.patch(
            Pod, "xz", Pod(metadata=ObjectMeta(labels={"l": "ok"})), namespace="other", patch_type=types.PatchType.APPLY
        )

    # test dry_run parameter
    req_dry = httpx2_mock.patch("https://localhost:9443/api/v1/namespaces/other/pods/xz?fieldManager=test&dryRun=All").respond(
        json={"metadata": {"name": "xz"}}
    )
    client.patch(
        Pod,
        ...
        patch_type=types.PatchType.STRATEGIC,
        namespace="other",
        field_manager="test",
        dry_run=True,
    )
...
def test_patch_global(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    ...
    # test dry_run parameter
    req_dry = httpx2_mock.patch("https://localhost:9443/api/v1/nodes/xz?fieldManager=test&dryRun=All").respond(
        json={"metadata": {"name": "xz"}}
    )
    node = client.patch(
        Node,
...
def test_set_namespaced(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
...
def test_set_global(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    req = httpx2_mock.patch(
...
def test_field_manager(kubeconfig, httpx2_mock: respx.Router) -> None:
    config = KubeConfig.from_file(str(kubeconfig))
    client = lightkube.Client(config=config, field_manager="lightkube")
    httpx2_mock.patch("https://localhost:9443/api/v1/nodes/xx?fieldManager=lightkube").respond(
        json={"metadata": {"name": "xx"}}
    )
    client.patch(Node, "xx", [{"op": "add", "path": "/metadata/labels/x", "value": "y"}], patch_type=types.PatchType.JSON)

    httpx2_mock.post("https://localhost:9443/api/v1/namespaces/default/pods?fieldManager=lightkube").respond(
        json={"metadata": {"name": "xx"}}
    )
    client.create(Pod(metadata=ObjectMeta(name="xx", labels={"l": "ok"})))

    httpx2_mock.put("https://localhost:9443/api/v1/namespaces/default/pods/xy?fieldManager=lightkube").respond(
        json={"metadata": {"name": "xy"}}
    )
    client.replace(Pod(metadata=ObjectMeta(name="xy")))

    httpx2_mock.put("https://localhost:9443/api/v1/namespaces/default/pods/xy?fieldManager=override").respond(
        json={"metadata": {"name": "xy"}}
    )
    client.replace(Pod(metadata=ObjectMeta(name="xy")), field_manager="override")


def test_create_namespaced(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    req = httpx2_mock.post("https://localhost:9443/api/v1/namespaces/default/pods").respond(json={"metadata": {"name": "xx"}})
    ...
    req2 = httpx2_mock.post("https://localhost:9443/api/v1/namespaces/other/pods").respond(json={"metadata": {"name": "yy"}})
    ...
    httpx2_mock.post("https://localhost:9443/api/v1/namespaces/ns2/pods").respond(json={"metadata": {"name": "yy"}})
...
def test_create_global(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    ...
    # dry-run
    req_dry = httpx2_mock.post("https://localhost:9443/api/v1/nodes").respond(json={"metadata": {"name": "xz"}})
    client.create(Node(metadata=ObjectMeta(name="xz")), dry_run=True)
    assert req_dry.calls[1][0].url.params["dryRun"] == "All"


def test_replace_namespaced(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    req = httpx2_mock.put("https://localhost:9443/api/v1/namespaces/default/pods/xy").respond(
        json={"metadata": {"name": "xy"}}
    )
    ...
    httpx2_mock.put("https://localhost:9443/api/v1/namespaces/other/pods/xz").respond(json={"metadata": {"name": "xz"}})
    ...
    # dry-run
    req_dry = httpx2_mock.put("https://localhost:9443/api/v1/namespaces/other/pods/xx").respond(
        json={"metadata": {"name": "xx"}}
    )
...
def test_replace_global(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    ...
    # dry-run
    req_dry = httpx2_mock.put("https://localhost:9443/api/v1/nodes/xy").respond(json={"metadata": {"name": "xy"}})
    pod = client.replace(Node(metadata=ObjectMeta(name="xy")), dry_run=True)
    assert req_dry.calls[0][0].url.params["dryRun"] == "All"


def test_pod_log(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
    result = ["line1\n", "line2\n", "line3\n"]
    content = "".join(result)
...
def test_exec_captures_stdout_stderr(client: lightkube.Client, monkeypatch) -> None:
    ...
    monkeypatch.setattr(websocket, "connect_ws", FakeWS.make_connect(messages, exit_code=0))
...
def test_exec_raises_on_non_zero_exit(client: lightkube.Client, monkeypatch) -> None:
    ...
    monkeypatch.setattr(websocket, "connect_ws", FakeWS.make_connect(messages, exit_code=12))
...
def test_exec_stdin_variants(client: lightkube.Client, monkeypatch) -> None:
    ...
    monkeypatch.setattr(websocket, "connect_ws", ws.as_connect())
    ...
    monkeypatch.setattr(websocket, "connect_ws", ws2.as_connect())
    ...
    monkeypatch.setattr(websocket, "connect_ws", ws3.as_connect())
    ...
    monkeypatch.setattr(websocket, "connect_ws", ws4.as_connect())
    client.exec("pod-stdin", command=["/bin/cmd"], stdin=None)
    assert ws4.sent == []


def test_apply_namespaced(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
...
def test_apply_global(client: lightkube.Client, httpx2_mock: respx.Router) -> None:
