...
def test_field_manager(kubeconfig) -> None:
    ...
    respx.post("https://localhost:9443/api/v1/namespaces/default/pods?fieldManager=lightkube").respond(
...
def test_create_namespaced(client: lightkube.Client) -> None:
    ...
    respx.post("https://localhost:9443/api/v1/namespaces/ns2/pods").respond(json={"metadata": {"name": "yy"}})
...
def test_create_global(client: lightkube.Client) -> None:
    ...
    # dry-run
    req_dry = respx.post("https://localhost:9443/api/v1/nodes").respond(json={"metadata": {"name": "xz"}})
...
def test_replace_namespaced(client: lightkube.Client) -> None:
    ...
    # dry-run
    req_dry = respx.put("https://localhost:9443/api/v1/namespaces/other/pods/xx").respond(json={"metadata": {"name": "xx"}})
...
def test_replace_global(client: lightkube.Client) -> None:
    ...
    # dry-run
    req_dry = respx.put("https://localhost:9443/api/v1/nodes/xy").respond(json={"metadata": {"name": "xy"}})
...
def test_pod_log(client: lightkube.Client) -> None:
    ...
    respx.get("https://localhost:9443/api/v1/namespaces/default/pods/test/log?follow=true").respond(content=content)
    lines = list(client.log("test", follow=True))
    assert lines == result

    respx.get("https://localhost:9443/api/v1/namespaces/default/pods/test/log?tailLines=3").respond(content=content)
